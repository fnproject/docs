...
With [Docker Compose file](https://github.com/fnproject/fn/blob/master/docker-compose.yml) it's easy to bootstrap the full Fn development stack that includes the following components:
